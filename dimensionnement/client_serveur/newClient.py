...
def traitement():
    ...
    lfsortie=LabelFrame(fsortie,text="Les Résultats de la File d'attente",font="arial 15 bold",labelanchor = N)
    lfsortie.pack(padx=5, pady=5, expand="yes")
    Label(lfsortie,text="La longueur moyenne de la file d'attente:", font=('Helvetica', 12)).grid(row=0, column=0)
    Label(lfsortie,text="Le nombre moyen de clients dans le systéme:", font=('Helvetica', 12)).grid(row=1, column=0)
    Label(lfsortie,text="Le temps moyen d'attente dans la file d'attente:", font=('Helvetica', 12)).grid(row=2, column=0)
    Label(lfsortie,text="Le nombre de serveurs inoccupés:", font=('Helvetica', 12)).grid(row=3, column=0)
    Label(lfsortie,text=nu, font=('Helvetica', 12)).grid(row=0 ,column=1)
    Label(lfsortie,text=n, font=('Helvetica', 12)).grid(row=1 ,column=1)
    Label(lfsortie,text=tf, font=('Helvetica', 12)).grid(row=2 ,column=1)
    Label(lfsortie,text=rho, font=('Helvetica', 12)).grid(row=3 ,column=1)

    lfsortie1=LabelFrame(fsortie,text="Les Résultats de Erlang C",font="arial 15 bold",labelanchor = N)
    lfsortie1.pack(padx=5, pady=5, expand="yes")
    Label(lfsortie1,text="La probabilite d'attente:", font=('Helvetica', 12)).grid(row=0, column=0)
    Label(lfsortie1,text="Le nombre moyen de clients en attente:", font=('Helvetica', 12)).grid(row=1, column=0)
    Label(lfsortie1,text="Le temps moyen d'attente dans la file d'attente:", font=('Helvetica', 12)).grid(row=2, column=0)
    Label(lfsortie1,text="Le temps de sejour:", font=('Helvetica', 12)).grid(row=3, column=0)
    Label(lfsortie1,text=probaAttente, font=('Helvetica', 12)).grid(row=0 ,column=1)
    Label(lfsortie1,text=nbclientAttente, font=('Helvetica', 12)).grid(row=1 ,column=1)
    Label(lfsortie1,text=tmpMoyFil, font=('Helvetica', 12)).grid(row=2 ,column=1)
    Label(lfsortie1,text=tmpSejour, font=('Helvetica', 12)).grid(row=3 ,column=1)

    b4=Button(lfsortie1,text="RESSAYER",bg="white",font="arial 10 bold",width="15" ,command=requete)
    b4.grid(row=4, column=0)
    b3=Button(lfsortie1,text="QUITTER",bg="white",font="arial 10 bold",width="15" ,command=fenetre.destroy)
