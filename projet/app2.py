...
def resolutionGauss():
    ...
    return render_template('resultatGauss.html',Matrice=Matrice,vecteur=vecteur,taille=taille,resultat=tab)
...
def resolutionLU():
    ...
    try:
        ...
        result+="Erreur Fichier"
    return render_template('resultatLU.html',Matrice=Matrice,vecteur=vecteur,taille=taille,resultat=tab,L=L,U=0)
