...
class AppBombardes(Frame):
	...
	def __init__(self, larg_c, haut_c):
		...
		self.jeu = Canvas(self, width =self.xm, height =self.ym,bg ='ivory', bd =3, relief =SUNKEN)
	...
	def specificites(self):
		...
		id_list =[("Paul","red"),("Roméo","cyan"),("Virginie","orange"),("Juliette","blue")]
		s = False
		for id, coul in id_list:
			...
			s = not s
			# changer de côté à chaque itération
